...
![Command Line Prompt](cl_prompt.png)
...
![Command not found](command_not_found.png)
...
[here](cli-cheatsheet.md) and
[here](additional-cli-cheatsheet.md) that are good references for
CLI.
...
## For those on Powershell

| Description                | Bash  | PowerShell |
| -------------------------- | ----- | ---------- |
| List files and folders     | ls    | ls         |
| Change directory           | cd    | cd         |
| Show Working directory     | pwd   | pwd        |
| Make New directory         | mkdir | mkdir      |
| Clear the Screen           | clear | clear      |
| To copy a file             | cp    | cp         |
| To remove or delete a file | rm    | rm         |
| To create a New text file  | touch | New-Item   |
| To view a  file            | cat   | cat        |
