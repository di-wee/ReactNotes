...
On your computer, create a directory in `sei-##-homework/u1/1.2a-arrays-lab with your name`. e.g. `sei-##-homework/u1/1.2a-arrays-lab/<your_name>`.

Create a file called **arrays.js** and do your homework in this file.

Copy the exercises below into **arrays.js** file and code away!
...
/*
Exercise 11:
  - Use a normal for or for...of loop to iterate through the provided nums array and add each odd number to a new array named odds.
...
/*
Exercise 12:
  - Use a normal for or for...of loop to iterate through the same nums array and add the number to **one** of the following arrays: fizz, buzz or fizzbuzz - based upon the following:
...
/*
Exercise 15:
  - Given the above numArrays array, use nested normal for or for...of loops to sum up all the numbers contained within numArrays and assign to a variable named total.
