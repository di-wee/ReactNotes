...
1. On your computer, create a directory in `sei-sg-##-homework/u1/1.4-dom-menu with your name`. i.e. `sei-sg-##-homework/u1/1.4-dom-menu/<your_name>`.

2. Create 3 files **index.html**, **style.css** and **script.js**.

3. Update the `<body>` element in the **index.html** to this:
...
Select and store the `<main>` element in a variable named `mainEl`.
...
Select and store the `<nav id="top-menu">` element in a variable named `topMenuEl`.
