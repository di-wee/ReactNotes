...
On your computer, create a directory in `sei-##-homework/u1/1.1-command-line` with your name. e.g. `sei-##-homework/u1/1.1-command-line/<dir_of_your_name>`.

Create a file called **answers.txt** and copy the commands into this file.

This lab is **a DELIVERABLE**.

* Open the **Terminal app**

* Create a directory called called `star_wars`. 
