...
☐ **Full-stack application** by making your own backend and your own front-end.
...
☐ **Require at least 2 types of login, example user and admin**, the different types should have differencial access to the APIs and Webpages

☐ **Implement and use at least 10 API endpoints** for CRUD functions, e.g. 1 endpoint for Create, 1 for Read and so on
